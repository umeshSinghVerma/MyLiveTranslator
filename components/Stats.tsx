export default function Stats() {
    ...
    const stats = [
        {
            data: "35K",
            desc: "Customers served since launch."
        },
        {
            data: "10K+",
            desc: "Downloads from app stores worldwide."
        },
        {
            data: "40+",
            desc: "Countries where MyLivTranslator is used."
        },
        {
            data: "30M+",
            desc: "Total revenue generated by MyLivTranslator."
        },
    ];


    return (
        <section id="stats" className=" relative py-28 bg-gray-900">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-2xl xl:mx-auto xl:text-center">
                    ...
                    <p className="mt-3 text-gray-300">
                        Join our community of satisfied users and experience seamless communication with MyLivTranslator.
                    </p>
                </div>
                <div className="mt-12">
