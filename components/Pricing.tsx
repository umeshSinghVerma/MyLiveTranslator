export default function Pricing() {
    ...
    const plans = [
        {
            name: "Enterprise",
            desc: "Ideal for large businesses needing comprehensive translation services.",
            price: 99,
            isMostPop: true,
            features: [
                "Unlimited live audio and video calls",
                "Priority real-time translation",
        ...
        {
            name: "Startup",
            desc: "Perfect for startups and small businesses looking to expand globally.",
            price: 29,
            isMostPop: false,
            features: [
                "50 hours of live audio and video calls per month",
    ...
    return (
        <section id="pricing" className='relative py-14 bg-gray-900'>
            ...
            <div className="relative max-w-screen-xl mx-auto text-gray-100 sm:px-4 md:px-8 z-30">
                <div className='max-w-xl mx-auto space-y-3 px-4 sm:text-center sm:px-0'>
                    ...
                    <div className='max-w-xl'>
                        <p>
                            Flexible plans that scale with your needs, ensuring you only pay for what you use.
                        </p>
                    </div>
                </div>
